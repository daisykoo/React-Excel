	...
	_renderToolbar() {
		...
		return (
			React.createElement("div", null, 
				React.createElement("button", {onClick: "self._redraw"}, "⇦"), 
				React.createElement("button", {onClick: "self._predraw"}, "⇨"), 
				React.createElement("button", {onClick: "self._toggleSearch", className: "toolbar"})
			)					
		)
	},
	_renderTable() {
