	...
	_renderToolbar() {
		...
		return (
			React.createElement("div", {style: {marginBottom: '10px'}}, 
				React.createElement("button", {onClick: "_redraw", className: "toolbar"}, "⇦"), 
				React.createElement("button", {onClick: "_predraw", className: "toolbar"}, "⇨"), 
				React.createElement("button", {onClick: "_toggleSearch", className: "toolbar"}, "搜索")
			)					
		)
	},
	_renderTable() {
